...
public class Movimentacao {
    ...
    public Integer getMovimentacaoId() { return movimentacaoId; }
    public void setMovimentacaoId(Integer movimentacaoId) { this.movimentacaoId = movimentacaoId; }
    ...
    public LocalDateTime getMomentoRetirada() { return momentoRetirada; }
    public void setMomentoRetirada(LocalDateTime momentoRetirada) { this.momentoRetirada = momentoRetirada; }

    public LocalDateTime getMomentoDevolucao() { return momentoDevolucao; }
    public void setMomentoDevolucao(LocalDateTime momentoDevolucao) { this.momentoDevolucao = momentoDevolucao; }

    public StatusRecurso getStatusRecurso() { return statusRecurso; }
    public void setStatusRecurso(StatusRecurso statusRecurso) { this.statusRecurso = statusRecurso; }
